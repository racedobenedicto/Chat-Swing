...
//View. Class with the graphical interface
import javax.swing.*;
import java.awt.*;
...
class Gui {   
    ...
    public Gui() {
        ...
        initializeEnter(); //Enter area
        initializeChat(); //Chat area
    }
    
    public void initializeEnter() {
        enterFrame = new JFrame("CHAT");
    ...
    public void addWidgetsEnter() {
        ...
        enterFrame.getContentPane().add(BorderLayout.CENTER, panelEnter); 
    ...
    public String getMsg(String action) {
    	switch(action) {
    	case "Enviar":
